      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="flex items-center gap-2 outline-none transition-shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring/80 focus-visible:ring-2 focus-visible:ring-ring/30"
            >
            ...
            <ul className="mt-4 space-y-3">
              {dictionary.footer.links.product.items.map((item, index) => (
                <li key={index}>
                  <Link
                    href="#"
                    className="text-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:underline"
                  >
                    {item}
                  </Link>
                </li>
