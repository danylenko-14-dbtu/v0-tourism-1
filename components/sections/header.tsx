        ...
        <nav className="hidden items-center gap-8 md:flex">
          {navItems.map((item) => (
            <ScrollLink
              key={item.href}
              href={item.href}
              className="focus-visible-ring text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:underline"
            >
              {item.label}
            </ScrollLink>
          ))}
