    ...
    >
      ...
      <div className="relative z-20 mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-footer! text-balance text-4xl font-bold tracking-wider sm:text-5xl lg:text-6xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 [text-shadow:_0_1px_3px_rgb(0_0_0_/_0.2)]">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
            <EnrollButton
              ...
              className="bg-footer text-footer-foreground shadow-footer/20 hover:bg-footer/90 focus-visible:bg-footer/90"
            />
            <Button
              asChild
              variant="outline"
